...
tabla_genero <- base_sexo |> 
  ...
  gt() %>%
  tab_header(
    title = "Distribución del Género en Argentina",
...
base_sexo |>
  ...
  gt() %>%
  tab_header(
    title = "Distribución del Género en Buenos Aires",
    subtitle = "Datos de género y frecuencia"
  ) %>%
  fmt_number(
    columns = c(Cantidad),
...
tabla |>
  ...
  gt()%>%
  tab_header(
    title = "Porcentaje de titulares por provincia y año",
...
para_tabla %>% 
  gt() %>%
  tab_header(
    title = "Porcentaje de titulares por año",
...
mapa_pba  %>%
  ...
  gt() %>%
  tab_header(
    title = "Porcentaje de titulares por año en Buenos Aires",
    subtitle = "En base a proyecciones poblacionales de INDEC"
  ) 
