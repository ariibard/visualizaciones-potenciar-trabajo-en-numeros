...
# Guardo tabla
gtsave(tabla_genero,filename = "graficos/html/distribucion_genero.html")
...
genero_pba
# Guardo tabla
gtsave(genero_pba, filename = "graficos/html/distribucion_genero_pba.html")
```
...
gtsave(tabla_por_prov, filename = "graficos/html/tabla_por_prov.html")
